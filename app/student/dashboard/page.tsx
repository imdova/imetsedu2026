...
import SiteHeader from "@/components/layout/headers/site-header";
      ...
      <div className="flex flex-1 flex-col">
        <div className="@container/main flex flex-1 flex-col gap-2">
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
            <div className="sd-grid px-4">
              {/* Welcome banner */}
              <section className="sd-welcome">
                <h2>Welcome back, {user?.name}! 👋</h2>
                <p>
                  You&apos;ve completed {dashboardStats.weeklyGoalPercent}% of
                  your weekly learning goal. Keep it up!
                </p>
              ...
              <section className="sd-next-up">
                ...
                <div className="sd-next-up-inner">
                  ...
                  <div className="sd-next-up-body">
                    ...
                    <div className="sd-next-up-title">
                      {nextUpSession.title}
                    </div>
                ...
                >
                  <div className="sd-installments-card-body">
                    ...
                    <p className="sd-installments-desc">
                      View payment roadmap, settle balances, and manage payment
                      methods.
                    </p>
                  ...
                  {activeCourses.map((c) => (
                    <div key={c.id} className="sd-course-card">
                      <div className="sd-course-image">
                        <span className="sd-course-module">
                          {c.moduleLabel}
                        </span>
                      </div>
                ...
                <section className="sd-activity">
                  ...
                  <div className="sd-activity-list">
                    {recentActivity.map((a) => {
                      ...
                      const rest =
                        colonIndex >= 0
                          ? a.text.slice(colonIndex + 1).trim()
                          : a.text;
                      return (
                    ...
                    <div key={a.id} className="sd-announcement-card">
                      ...
                      <div className="sd-announcement-body">
                        <div className="sd-announcement-meta">
                          <span className="sd-announcement-author">
                            {a.author}
                          </span>
